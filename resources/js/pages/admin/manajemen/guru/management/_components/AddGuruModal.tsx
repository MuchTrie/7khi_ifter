...
export default function AddGuruModal({ isOpen, onClose }: AddGuruModalProps) {
            ...
            <div className="w-full max-w-2xl rounded-xl bg-white p-4 shadow-2xl sm:rounded-2xl sm:p-6 lg:p-8">
                ...
                <form className="space-y-3 sm:space-y-4">
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-transparent focus:ring-2 focus:ring-green-500 sm:px-4"
                            />
                        </div>
                        <div>
                            <label className="mb-2 block text-xs font-medium text-gray-900 sm:text-sm">
                    ...
                    <div className="mt-4 flex flex-col justify-end gap-2 sm:mt-6 sm:flex-row sm:gap-3">
                        ...
                        <button
                            type="submit"
                            className="rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-700 sm:px-6 sm:text-base"
                        >
                            Simpan Guru
                        </button>
                    </div>
