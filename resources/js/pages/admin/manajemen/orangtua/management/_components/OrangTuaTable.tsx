...
export default function OrangTuaTable({
    orangtua,
    sortBy,
    sortOrder,
    onSort,
                            ...
                            >
                                ...
                                <td className="px-2 py-3 sm:px-4 sm:py-4">
                                    <div className="flex justify-center gap-1 sm:gap-2">
                                        <button className="rounded-lg bg-purple-500 px-2 py-1 text-xs font-medium text-white transition-colors hover:bg-purple-600 sm:px-3 sm:text-sm">
                                            Edit
                                        </button>
